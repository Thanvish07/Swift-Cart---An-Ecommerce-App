...
const ProductDetails = () => {
    ...
    const addToCart = async (product) => {
        try {
            ...
            if (product.quantity > 0) {
                ...
                await axios.put(`/api/v1/product/update-quantity/${product._id}`, {
                    quantity: product.quantity - 1,
                });
            } else {
                toast.error("Product is out of stock"); // Show error toast
            }
        } catch (error) {
            console.log(error);
        }
    ...
    return (
        <Layout title={'Product Details - Swift Cart'}>
            <div className="row container product-details">
                {product && ( // Conditionally render if product exists
                    <>
                        ...
                        <div className="col-md-6 product-details-info">
                            ...
                            <button
                                ...
                                onClick={() => addToCart(product)} // Pass product to addToCart function
                            >
                                ADD TO CART
                            </button>
                        </div>
